...
window.COArenderer = (function () {
  ...
  const shieldPaths = {
    ...
    oldFrench:
      "m25,25 h150 v75 a100,100,0,0,1,-75,100 a100,100,0,0,1,-75,-100 z",
    renaissance:
  ...
  const draw = async function (id, coa) {
    let { shield, division, ordinaries = [], charges = [] } = coa;
    ...
    const svg = `<svg id="${id}" class="img-fluid" width="200" height="200" viewBox="${viewBox}">
  ...
  async function fetchCharge(charge, id) {
    const fetched = fetch("/fmg/charges/" + charge + ".svg")
      .then((res) => {
