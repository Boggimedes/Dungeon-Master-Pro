...
import { ConfigService } from "../../../../angular/app/shared/services/config.service";
import { DOCUMENT } from "@angular/common";
import { Subscription } from "rxjs";
import { CustomizerService } from "../../../../angular/app/shared/services/customizer.service";
import { DeviceDetectorService } from "ngx-device-detector";
import { LayoutService } from "../../../../angular/app/shared/services/layout.service";
import { WINDOW } from "../../../../angular/app/shared/services/window.service";
...
export class FullLayoutComponent implements OnInit, AfterViewInit, OnDestroy {
	...
	sidebarMouseenter(e) {
		if (this.config.layout.sidebar.collapsed) {
			...
			this.layoutService.overlaySidebartoggle(
