...
export class CombatService {
  ...
  constructor(@Inject(LOCAL_STORAGE) private storage: StorageService, private http: HttpClient) {
   ...
   public spell = (combatant, spell, adv) => {
	...
	combatTurn = (combatant: string | Combatant = null, attack: string | Attack | Multiattack = null, adv: string = null) => {
		let damage = null;
		let log: any = {};
		let actor;
		console.log(actor);
	...
	private processAttack(combatant: string | Combatant , attack: Attack , adv: string) {
		let damage = null;
		let log: any = {};
